...
@app.route('/action_list', methods=['POST'])
def action_list():
...
@app.route('/action_execute', methods=['POST'])
def action_execute():
    r = request.get_json()
    app.logger.info(r)

    message = r['form_params']['message']
